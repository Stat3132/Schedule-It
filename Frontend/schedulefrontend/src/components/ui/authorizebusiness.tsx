          ...
          <div className="border-2 border-slate-200 rounded-xl p-4 hover:border-blue-300 transition">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 text-blue-600 border-slate-300 focus:ring-2 focus:ring-blue-500 cursor-pointer mt-1"
                required
              />
              <div className="flex-1">
                <span className="block font-semibold text-slate-800 mb-1">
                  I am the owner/authorized officer<span className="text-red-500 ml-1">*</span>
                </span>
          ...
          <div className="border-2 border-slate-200 rounded-xl p-4 hover:border-blue-300 transition">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-2 focus:ring-blue-500 cursor-pointer mt-1"
                required
              />
